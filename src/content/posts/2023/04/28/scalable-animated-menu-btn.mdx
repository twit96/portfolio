...
heroImage: "/blog/2023/04/28/scalable-animated-menu-btn/title-card.png"
links: [
  { text: "Skip the article and view the Codepen", href: "https://codepen.io/twit96/pen/poxPzyQ", },
]
relatedPosts:
- portfolio-2022
slug: 2023/04/28/scalable-animated-menu-btn
tags:
- tutorial
- ui
- animation
...
<PostSection>
  <PostSectionContent slot="content">
    ...
    <video width="514" height="514" controls>
      <source src="/blog/2023/04/28/scalable-animated-menu-btn/6.mp4" type="video/mp4" />
      Download the 
      <a href="/blog/2023/04/28/scalable-animated-menu-btn/6.mp4">MP4</a>
    </video>
...
```
      ...
      we should not nest block-level elements inside of it, such as <CodeInline>``</CodeInline> or 
...
```
      ...
      <img src="/blog/2023/04/28/scalable-animated-menu-btn/1.png" alt="Initial Button Layout" />
...
```
    ...
    <PostSectionSidebar slot="sidebar">
        ...
        Read more about CSS Animations here 
        <a 
        ...
        Read more about the CSS animation timing function property here  
        <a 
  ...
  <PostSection slot="sub-section">
    <PostSectionContent slot="content">
      ...
      <video width="516" height="516" controls>
        <source src="/blog/2023/04/28/scalable-animated-menu-btn/2.mp4" type="video/mp4" />
        Download the 
        <a href="/blog/2023/04/28/scalable-animated-menu-btn/2.mp4">MP4</a>
      </video>
  ...
  <PostSection slot="sub-section">
    <PostSectionContent slot="content">
      ...
      <video width="1920" height="1080" controls>
        <source src="/blog/2023/04/28/scalable-animated-menu-btn/3.mp4" type="video/mp4" />
        Download the 
        <a href="/blog/2023/04/28/scalable-animated-menu-btn/3.mp4">MP4</a>
      </video>
...
<PostSection>
  <PostSectionContent slot="content">
    ...
    <img src="/blog/2023/04/28/scalable-animated-menu-btn/4.png" alt="Both States Illustration" width="428" height="248" />
...
```
      ...
      The units that we already set will simply be divided by 10 and multiplied by our <CodeInline>`--btn-size`</CodeInline> variable. 
...
```
      ...
      <video width="1294" height="772" controls>
        <source src="/blog/2023/04/28/scalable-animated-menu-btn/5.mp4" type="video/mp4" />
        Download the 
        <a href="/blog/2023/04/28/scalable-animated-menu-btn/5.mp4">MP4</a>
      </video>
